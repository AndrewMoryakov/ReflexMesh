...
- Live-подтверждение прямого провайдера typesafe; смысловой отказ маршрутизации (см. V0.3).
...
(корректный отказ 25% против 79% у LLM). Следующий шаг по [плану](ROADMAP.md) — V0.4.
